...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public String getTotalDuration(){
        ...
        long hour = Math.abs(TimeUnit.MILLISECONDS.toHours(duration));
        long minute = Math.abs(TimeUnit.MILLISECONDS.toMinutes(duration) - TimeUnit.HOURS.toMinutes(TimeUnit.MILLISECONDS.toHours(duration)));
        long second = Math.abs(TimeUnit.MILLISECONDS.toSeconds(duration) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(duration)));
